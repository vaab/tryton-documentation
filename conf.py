...
project = u'Tryton'
copyright = u'2013, Tryton Community'
...
latex_documents = [
  ('index', 'Tryton.tex', u'Tryton Documentation',
   u'Tryton Community', 'manual'),
]
...
man_pages = [
    ('index', 'tryton', u'Tryton Documentation',
     [u'Tryton Community'], 1)
]
...
texinfo_documents = [
  ('index', 'Tryton', u'Tryton Documentation',
   u'Tryton Community', 'Tryton', 'One line description of project.',
   'Miscellaneous'),
]
